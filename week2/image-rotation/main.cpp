...
int main(int argc, char *argv[]) {
  ...
  CHECK_CUDA(cudaMallocHost(&input_images,sizeof(float) * num_src_images * IMAGE_SIZE));
  CHECK_CUDA(cudaMallocHost(&output_images,sizeof(float) * num_src_images * IMAGE_SIZE));
